...
1. CMS repo
   ...
   - Local path: `/Users/linktrend/Projects/Dev_Sites/sites_cms/payload-cms`
...
2. Frontend template repo
   ...
   - Local path: `/Users/linktrend/Projects/Dev_Sites/sites_templates/website-master-template`
...
```bash
cd /Users/linktrend/Projects/Dev_Sites/sites_cms/payload-cms
```

Frontend repo:

```bash
cd /Users/linktrend/Projects/Dev_Sites/sites_templates/website-master-template
```
...
Use:
- `/Users/linktrend/Projects/Dev_Sites/library/operations/RELEASE_LOG.md`
...
- Workflow overview: `/Users/linktrend/Projects/Dev_Sites/LINKSITES_FACTORY_KIT_WORKFLOW.md`
- Git strategy: `/Users/linktrend/Projects/Dev_Sites/library/operations/GIT_STRATEGY.md`
- Ops runbook: `/Users/linktrend/Projects/Dev_Sites/library/operations/OPS_RUNBOOK.md`
- Release log: `/Users/linktrend/Projects/Dev_Sites/library/operations/RELEASE_LOG.md`
