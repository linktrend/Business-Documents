...
- `/Users/linktrend/Projects/Dev_Sites/library/operations/REPO_OPERATOR_SOP.md`
...
2. Put the connection string in `/Users/linktrend/Projects/Dev_Sites/sites_cms/payload-cms/.env` as `DATABASE_URI=...`.
3. Start the CMS and run the bootstrap seed (creates languages/role/default site mappings):
```bash
cd sites_cms/payload-cms
pnpm dev
